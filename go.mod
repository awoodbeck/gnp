...
require (
	github.com/awoodbeck/caddy-restrict-prefix v1.0.4
	github.com/awoodbeck/caddy-toml-adapter v1.0.4
	github.com/awoodbeck/gnp/ch14/feed v0.0.0-20231201142733-ad967f805fd5
