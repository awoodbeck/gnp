...
require (
	github.com/awoodbeck/caddy-restrict-prefix v1.0.5
	github.com/awoodbeck/caddy-toml-adapter v1.0.5
	github.com/awoodbeck/gnp/ch14/feed v0.0.0-20250815230758-d2389d7a9c2d
